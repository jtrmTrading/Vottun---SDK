...
$apiApp =''; //colocar Id app dentro de las comillas
$apiKey = ''; //colocar Api Key dentro de las comillas
$network1 = 80001; // colocar id de red
$erc20 = ''; //colocar Token erc20 dentro de las comillas
$wallet = ''; //colocar Wallet dentro de las comillas
